...
to update-turtles ; Update turtles with their new energy, kill turtles with energy < 1 and hatch from turtles with energy > 100
  ask agents2 [
    ...
    if energy > 100 [ set energy 50 hatch 1 [ lt random 360 fd 1 ] ] ; Breed a new turtle 1 step away from the parent
  ]
end
...
1104
276
Aggressive vs non-aggressive turtles
NIL
NIL
0.0
100.0
...
<experiments>
  <experiment name="experiment" repetitions="5" runMetricsEveryStep="false">
    ...
    <metric>count turtles with [ aggression_type = "Non-aggressive" ]</metric>
    <metric>count agents2</metric>
    <enumeratedValueSet variable="value_of_food">
      <value value="20"/>
      <value value="40"/>
      <value value="60"/>
      <value value="80"/>
    ...
    <enumeratedValueSet variable="constant_energy_loss">
      <value value="1"/>
      <value value="2"/>
      <value value="3"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="amount_of_food">
      <value value="30"/>
      <value value="60"/>
      <value value="90"/>
      <value value="120"/>
