...
to go
  ask agents2[
    fd 5 ; increased from 2. Turtles have very little encounters with others or food
    lt random 360
  ]
  interact
  update-turtles
...
;- The more you fight the more you get - You leave you keep starving.
; 1. If fight, more aggressive turtle/s doubles energy, losing aggressive turtle/s pay penalty. (fight only when food present?)
; 2. Escaping turtles do not gain, lose energy per cicle.
 ; ask agents2[ aggression-level
...
"" ""
PENS
"default" 1.0 0 -5298144 true "" "plot count turtles with [color = \"blue\"]"
...
"" ""
PENS
"default" 1.0 0 -8990512 true "" "plot count foods"
